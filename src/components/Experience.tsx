...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      period: '2015 - 2019',
      description: 'Developed custom websites and web applications for clients across various industries. Specialized in creating responsive, user-friendly interfaces using modern JavaScript frameworks. Collaborated directly with clients to translate business requirements into technical solutions.',
    },
    {
